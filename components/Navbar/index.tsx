    ...
    <div className="p-0 lg:p-[15px_30px] sticky top-0 flex flex-col lg:flex-row lg:items-center justify-start lg:justify-between w-full ">
      ...
      {isClient &&
        ReactDOM.createPortal(
          <div
            className={`${
              isMenuOpen ? "left-0" : "left-[-100%] lg:left-0"
            } z-[9999999] fixed top-0 lg:relative flex flex-col lg:flex-row items-start lg:items-center lg:space-x-[20px] space-y-[20px] lg:space-y-0 p-[20px_15px] bg-gray-300 lg:bg-transparent transition-all h-screen lg:h-fit w-[70%] md:w-[50%] lg:w-fit`}
          >
